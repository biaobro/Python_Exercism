...
class LocomotiveEngineer(unittest.TestCase):
    ...
    def test_add_missing_stops(self):
        input_data = (
            ...
            ({'from': 'Gothenburg', 'to': 'Copenhagen'},
             {'stop_1': 'Kungsbacka', 'stop_2': 'Varberg', 'stop_3': 'Halmstad', 'stop_4': 'Angelholm',
              'stop_5': 'Lund',
              'stop_6': 'Malmo'})
        )
    ...
    def test_extend_route_information(self):
        input_data = [({'from': 'Berlin', 'to': 'Hamburg'},
        ...
        output_data = [
            {'from': 'Berlin', 'to': 'Hamburg', 'timeOfArrival': '12:00', 'precipitation': '10', 'temperature': '5',
             'caboose': 'yes'},
            {'from': 'Paris', 'to': 'London', 'timeOfArrival': '10:30', 'temperature': '20', 'length': '15'},
            {'from': 'Gothenburg', 'to': 'Copenhagen', 'precipitation': '1', 'timeOfArrival': '21:20',
             'temperature': '-6'}
        ]
    ...
    def test_fix_wagon_depot(self):
        input_data = (
            [[(2, 'red'), (4, 'red'), (8, 'red')], [(5, 'blue'), (9, 'blue'), (13, 'blue')],
             [(3, 'orange'), (7, 'orange'), (11, 'orange')]],
            [[(6, 'blue'), (10, 'blue'), (14, 'blue')], [(7, 'red'), (4, 'red'), (2, 'red')],
             [(3, 'orange'), (11, 'orange'), (15, 'orange')]],
            [[(7, 'pink'), (4, 'pink'), (2, 'pink')], [(10, 'green'), (6, 'green'), (14, 'green')],
             [(9, 'yellow'), (5, 'yellow'), (13, 'yellow')]],
            [[(3, 'purple'), (11, 'purple'), (15, 'purple')], [(20, 'black'), (16, 'black'), (12, 'black')],
             [(19, 'white'), (17, 'white'), (18, 'white')]]
        )

        output_data = (
            [[(2, 'red'), (5, 'blue'), (3, 'orange')], [(4, 'red'), (9, 'blue'), (7, 'orange')],
             [(8, 'red'), (13, 'blue'), (11, 'orange')]],
            [[(6, 'blue'), (7, 'red'), (3, 'orange')], [(10, 'blue'), (4, 'red'), (11, 'orange')],
             [(14, 'blue'), (2, 'red'), (15, 'orange')]],
            [[(7, 'pink'), (10, 'green'), (9, 'yellow')], [(4, 'pink'), (6, 'green'), (5, 'yellow')],
             [(2, 'pink'), (14, 'green'), (13, 'yellow')]],
            [[(3, 'purple'), (20, 'black'), (19, 'white')], [(11, 'purple'), (16, 'black'), (17, 'white')],
